...
tf.app.flags.DEFINE_string('testing', 'C:/Users/w03798/Desktop/Logs', """ checkpoint file """)
...
tf.app.flags.DEFINE_string('logs_dir', "./Logs/", """ dir to store ckpt """)
tf.app.flags.DEFINE_string('image_dir', "D:/DATA/voc2012/VOC2012/ImageSets/Segmentation/train.txt", """ path to CamVid image """)
tf.app.flags.DEFINE_string('test_dir', 'D:/DATA/voc2012/VOC2012/ImageSets/Segmentation/test.txt', """ path to CamVid test image """)
tf.app.flags.DEFINE_string('val_dir', "D:/DATA/voc2012/VOC2012/ImageSets/Segmentation/train.txt", """ path to CamVid val image """)
...
tf.app.flags.DEFINE_integer('num_class', "21", """ total class number """)
...
def checkArgs():
    ...
    print("Log dir: %s"%FLAGS.logs_dir)
