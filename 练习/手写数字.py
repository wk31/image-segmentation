# -*- coding: utf-8 -*-
"""
Created on Mon Oct 14 11:13:28 2019
...
num_batches=int(data_loader.num_train_data//batch_size*num_epochs)-18200
print(num_batches)
...
print("训练结束")   
tf.saved_model.save(model,"./cpre") 

sparse_categorical_accuracy=tf.keras.metrics.SparseCategoricalAccuracy()
num_batches=int(data_loader.num_test_data//batch_size)-151
for batch_index in range(num_batches):
    print("评价模型")
